...
\label{sec:setting}
The experimental simulation is based on secondary development of the Minimax and Alpha-Beta pruning engine from the open-source project by Liu~\cite{liuweilhy2018ninechess}. To enable the engine to handle asymmetric resources and asynchronous phases, we revise the codes and integrate the Mixed Preemptive Rule into its underlying state machine.
